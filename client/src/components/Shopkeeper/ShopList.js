  ...
  return (
    <div className='w-10/12 flex flex-col justify-center space-y-8 p-4 mx-auto'>
        ...
        <div className='flex mt-2 justify-center items-center '>
            {/* Card */}
            <div className='bg-[#D1FFF2]  shadow-[0_3px_0_0] shadow-[#2EC4B6EB]/50  max-w-[90%] w-[700px] flex flex-col px-10 py-8 rounded-md'>

              <p className='text-black text-[24px]'>Start selling <span className='text-[#174B3A]'>E-waste</span> Now!</p>
