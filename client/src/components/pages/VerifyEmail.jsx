    ...
    return (
          ...
          <div className="spinner"></div>
            ...
            <div className='w-10/12 bg-[#fff] mx-auto rounded-3xl p-10'>
                ...
                <div className='flex flex-col gap-5 items-center justify-center'>
                    ...
                    <p className=' text-[#174B3A] text-[18px] font-roboto font-normal max-w-[300px] text-center'>A verification code was sent to <span className=' font-medium'>Your Given Address...</span></p>
        ...
        aspect-square text-center focus:border-0 focus:outline-2 focus:outline-yellow-50'
                        ...
                        <div className=' mt-10 text-center'>
                            <button className=' bg-[#05ac7d] text-white py-4 px-12 rounded-3xl text-[28px] font-semibold hover:scale-105 transition-all duration-200 font-roboto'>
                                Verify email
                            </button>
                        </div>
                    </form>

                    <p className=' font-roboto text-2xl font-normal max-w-[400px] text-center'>Didn’t received verification mail? <span className=' font-medium text-[#05ac7d] underline'><Link onClick={() => dispatch(sendOtp(signupData.email))}>Resend it</Link></span></p>
                </div>
            </div>
        )}
